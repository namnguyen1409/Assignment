...
<body>
    ...
    <c:choose>
        <c:when test="${tab == 'basic'}">
            <h1 class="text-center mb-3">Thông tin cơ bản</h1>
            <c:url value="/register/basic" var="basic"/>
            <form:form modelAttribute="userBasicInfo" action="${basic}" method="post" cssClass="md-border ">
                <%-- cfrs token --%>
                ...
                <div class="form-group">
                    ...
                    <form:password path="rePassword" id="rePassword" class="form-control" required="required" />
                    <%-- error --%>
