...
<div class="bg-light p-3">
    <h1> Đăng ký dịch vụ ví điện tử</h1>
    ...
    <div class="form-group">
        <form:form modelAttribute="ewalletRegisterDTO" cssClass="mb-5" action="" method="POST">
            <%-- nhập mã pin --%>
            <div class="mb-3">
                <label for="pin" class="form-label">Nhập mã pin</label>
                <form:input path="pin" type="password" class="form-control" id="pin" />
                <form:errors path="pin" cssClass="text-danger"/>
            </div>
            <%-- nhập lại mã pin --%>
            <div class="mb-3">
                <label for="confirmPin" class="form-label">Nhập lại mã pin</label>
                <form:input path="confirmPin" type="password" class="form-control" id="confirmPin" />
                <form:errors path="confirmPin" cssClass="text-danger"/>
            </div>

            <p class="text-danger">* 
                Bằng việc bạn tick vào ô bên dưới, bạn đã đồng ý với các điều khoản sử dụng dịch vụ ví điện tử của chúng tôi
            </p>
